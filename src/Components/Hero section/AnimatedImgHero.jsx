...
const ShuffleHero = () => {
  return (
    <section className="w-[1500px] px-8 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 mx-auto">
      <div>
...
const ShuffleGrid = () => {
  ...
  return (
    <div className="grid grid-cols-4 grid-rows-4 h-[70vh] gap-1">
      {squares.map((sq) => sq)}
    </div>
  );
};
