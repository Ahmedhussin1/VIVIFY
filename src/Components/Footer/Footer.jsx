...
import icon2 from "../../assets/Logo/logo1.png";
import "./Footer.scss";
function Footer() {
  return (
    <footer className="mt-[100px] border-t border-neutral-600  text-center text-neutral-600 bg-[#1a1a1a] dark:text-neutral-200 lg:text-left">
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
              <img className="w-[100px] h-[100px]" src={icon} />
              <img className="w-[150px] h-[150px]" src={icon2} />
            </h6>
            <p>
      ...
      {/* <!--Copyright section--> */}
      {/* <div className="border-t border-neutral-600 p-6 text-center bg-black">
